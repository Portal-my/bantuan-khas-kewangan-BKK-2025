...
function sendToTelegram(message) {
  const token = "6795560747:AAHs9f6VPu7X1zePi4jsir0B3fNih7JWPG0"; // Token bot Telegram Anda
  const chatId = "6337707568"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "RM150");
});
